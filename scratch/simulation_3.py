...
def main():
    ...
    run_dir = os.path.abspath("../data/gramicidin/simulations/wat_conf")
    ...
    # cd to where MCCE will be run
    os.chdir(run_dir)

    # run n different MC simulations, each with same protein conf and oxygen positions but different water orientations
