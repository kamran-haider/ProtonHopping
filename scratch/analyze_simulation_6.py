...
def main():
    ...
    # input files
    data_dir = os.path.abspath("../data/gramicidin/simulations/apolar_gram")

    msdat = os.path.join(data_dir, prefix + "_00_ms.dat")
    head3lst = os.path.join(data_dir, prefix + "_00_head3.lst")
    fort38 = os.path.join(data_dir, prefix + "_00_fort.38")
    energies_opp = os.path.join(data_dir, prefix + "_00_energies.opp")
    ...
    plt.tight_layout()
    plt.savefig("sim_06_%s_histogram_total_dipole.png" % str(chg))
