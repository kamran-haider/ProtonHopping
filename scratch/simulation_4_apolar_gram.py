...
def main():
    ...
    home_dir = os.path.abspath("../data/gramicidin/simulations/apolar_gram_%s" % prefix)
    ...
    for n in range(n_runs):
        if n not in []:
            ...
            m.edit_parameters(INPDB="step2_out.pdb",
                              ...
                              DO_MONTE="f", MONTE_ADV_OPT="f", MONTE_MS="t",
                              MONTE_REDUCE="0.0001", BIG_PAIRWISE="1.0", MONTE_RUNS="25")
